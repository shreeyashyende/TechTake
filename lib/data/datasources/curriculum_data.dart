...
// Contains 389 technical vocabulary words
...
final List<WordModel> curriculumData = [
  WordModel(
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why do we still talk in bits if most modern data is measured in Gigabytes?',
    conversationA: 'Bits represent the physical reality of the hardware. When we optimize network protocols or embedded firmware, we care about individual wire states to minimize overhead.',
  ),
  WordModel(
    id: 'word-byte',
    word: 'Byte',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why is a byte exactly 8 bits?',
    conversationA: 'It became an industry standard with the IBM System/360. 8 bits was enough for the EBCDIC character set and proved a sweet spot for hardware architecture.',
  ),
  WordModel(
    id: 'word-binary',
    word: 'Binary',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Does the CPU actually \'read\' 1s and 0s?',
    conversationA: 'Physically, it\'s just low/high voltage. We use 1 and 0 as logical abstractions to represent those physical electricity states in our design.',
  ),
  WordModel(
    id: 'word-latency',
    word: 'Latency',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why is our app sluggish even though we have 1Gbps fiber?',
    conversationA: 'Bandwidth is huge, but latency is the bottleneck. The physical distance to the server is causing a 200ms delay per request. We need a CDN.',
  ),
  WordModel(
    id: 'word-bandwidth',
    word: 'Bandwidth',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Should we upgrade bandwidth to solve slow SQL queries?',
    conversationA: 'Probably not. SQL slowness is usually about query execution time (latency), not the size of the data pipe.',
  ),
  WordModel(
    id: 'word-throughput',
    word: 'Throughput',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why is our throughput dropping on the 10Gbps link?',
    conversationA: 'It\'s likely due to TCP window scaling or packet retransmissions at the switch level. We need to check for frame errors.',
  ),
  WordModel(
    id: 'word-ping',
    word: 'Ping',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'The server pings fine, so why can\'t I access the website?',
    conversationA: 'Ping only confirms the network layer is up. The web server (application layer) might be crashed or blocking port 443.',
  ),
  WordModel(
    id: 'word-packet-loss',
    word: 'Packet Loss',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why is the video call choppy on a 100Mbps link?',
    conversationA: 'You have 5% packet loss. Even with a fast pipe, pieces of the video are being lost, forcing the app to drop frames.',
  ),
  WordModel(
    id: 'word-buffer',
    word: 'Buffer',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why is the video still buffering if I have fast internet?',
    conversationA: 'The server might be struggling to fill your local buffer fast enough, or there\'s jitter causing the buffer to empty too soon.',
  ),
  WordModel(
    id: 'word-hardware',
    word: 'Hardware',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Is the software slow, or the hardware?',
    conversationA: 'We are hitting IOPS limits on the disk. It\'s a hardware bottleneck that no amount of code refactoring can fix without an SSD upgrade.',
  ),
  WordModel(
    id: 'word-cpu',
    word: 'CPU',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Should we optimize for CPU or RAM usage?',
    conversationA: 'Our current bottleneck is CPU cycles on our serverless functions. We should optimize our algorithms to reduce billable execution time.',
  ),
  WordModel(
    id: 'word-ram',
    word: 'RAM',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why did my app crash with OutOfMemory?',
    conversationA: 'You loaded a 2GB CSV into a single variable. We need to stream the file from disk instead of buffering the whole thing in RAM.',
  ),
  WordModel(
    id: 'word-ssd',
    word: 'SSD',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Language of Machines',
    conversationQ: 'Why is the database faster after the migration?',
    conversationA: 'We moved from HDD to NVMe SSDs. The random I/O performance is now 50x faster, which is critical for query indexes.',
  ),
  WordModel(
    id: 'word-kernel',
    word: 'Kernel',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'What happens during a context switch at the kernel level?',
    conversationA: 'The kernel saves the state of the current process and restores the next. Excessive switching causes overhead.',
  ),
  WordModel(
    id: 'word-process',
    word: 'Process',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Why use multi-processing in Python?',
    conversationA: 'To bypass the Global Interpreter Lock (GIL). Each process gets its own interpreter and can run on a different core.',
  ),
  WordModel(
    id: 'word-thread',
    word: 'Thread',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Is this code thread-safe?',
    conversationA: 'No, we\'re modifying a global counter without a lock. Two threads could read the same value and overwrite each other.',
  ),
  WordModel(
    id: 'word-context-switch',
    word: 'Context Switch',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Why is system load high but CPU usage low?',
    conversationA: 'High context switching. We have too many active threads competing for time, causing the scheduler to work overtime.',
  ),
  WordModel(
    id: 'word-scheduler',
    word: 'Scheduler',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Why is the background backup slowing down the UI?',
    conversationA: 'The scheduler is giving the backup too much priority. We should \'nice\' the backup process to a lower priority.',
  ),
  WordModel(
    id: 'word-deadlock',
    word: 'Deadlock',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'The DB connection is hanging. Deadlock?',
    conversationA: 'Likely. Transaction A is waiting for a lock held by B, and B is waiting for one held by A. We need a deadlock detector.',
  ),
  WordModel(
    id: 'word-system-call',
    word: 'System Call',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Why is this logging so slow?',
    conversationA: 'Every log line is a separate \'write\' system call. We should buffer the logs and write them in chunks to reduce kernel overhead.',
  ),
  WordModel(
    id: 'word-virtual-memory',
    word: 'Virtual Memory',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Why is the server grinding to a halt?',
    conversationA: 'It\'s hitting virtual memory swap. Physical RAM is full, and reading from the SSD is 100x slower than RAM.',
  ),
  WordModel(
    id: 'word-daemons',
    word: 'Daemons',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Is the database service still running?',
    conversationA: 'Yes, the \'mongod\' daemon is active in the background and listening for connections.',
  ),
  WordModel(
    id: 'word-bootloader',
    word: 'Bootloader',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'The computer is stuck on the splash screen. Bootloader issue?',
    conversationA: 'Could be. GRUB (the bootloader) might not be able to find the kernel image on the disk partition.',
  ),
  WordModel(
    id: 'word-user-space',
    word: 'User Space',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'Why did my app crash but my computer stayed on?',
    conversationA: 'The crash happened in user space. The kernel detected the error and simply stopped your process to protect itself.',
  ),
  WordModel(
    id: 'word-kernel-space',
    word: 'Kernel Space',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Operating System (Kernel)',
    conversationQ: 'What caused the Blue Screen of Death?',
    conversationA: 'A driver had a null pointer exception in kernel space. Since the kernel is the base of everything, the whole system crashed.',
  ),
  WordModel(
    id: 'word-cli',
    word: 'CLI',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'Why use CLI when we have a desktop app for git?',
    conversationA: 'CLI allows me to chain commands together and use aliases for repetitive tasks that the GUI doesn\'t support.',
  ),
  WordModel(
    id: 'word-shell',
    word: 'Shell',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'Which shell are you using?',
    conversationA: 'I moved to Zsh with Oh My Zsh for the better auto-completion and plugin support compared to default Bash.',
  ),
  WordModel(
    id: 'word-bash',
    word: 'Bash',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'Can you share that automation script?',
    conversationA: 'Sure, it\'s just a simple Bash script. Make sure you have \'bash\' installed in your PATH.',
  ),
  WordModel(
    id: 'word-terminal',
    word: 'Terminal',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'Is the terminal just for hackers?',
    conversationA: 'Not at all. For developers, it\'s often the fastest way to compile code, run tests, or manage servers across the world.',
  ),
  WordModel(
    id: 'word-root',
    word: 'Root',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'Why can\'t I edit this config file?',
    conversationA: 'It\'s owned by root. You need to use \'sudo\' to get administrative permissions to change it.',
  ),
  WordModel(
    id: 'word-permissions-chmod-',
    word: 'Permissions (chmod)',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'My script won\'t run. Permision denied?',
    conversationA: 'You need to add the execute bit. Run \'chmod +x script.sh\' and try again.',
  ),
  WordModel(
    id: 'word-path',
    word: 'Path',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'I just installed Node, but \'node\' command not found?',
    conversationA: 'The installer likely didn\'t add the Node binary folder to your PATH variable. Check your .zshrc file.',
  ),
  WordModel(
    id: 'word-standard-output-stdout-',
    word: 'Standard Output (stdout)',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'How do I save the command results to a file?',
    conversationA: 'Just redirect the stdout. Run \'ls > files.txt\' to pipe the output into that file.',
  ),
  WordModel(
    id: 'word-pipe',
    word: 'Pipe',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'How do I find a specific process?',
    conversationA: 'Pipe the process list to grep: \'ps aux | grep node\'. It\'s much faster than reading the whole list.',
  ),
  WordModel(
    id: 'word-scripts',
    word: 'Scripts',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'How do we automate the database backup?',
    conversationA: 'I\'ll write a simple shell script and schedule it with a cron job to run every midnight.',
  ),
  WordModel(
    id: 'word-sudo',
    word: 'Sudo',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'I can\'t install this package.',
    conversationA: 'You need to use sudo. Run \'sudo apt install package-name\' to give the installer root access.',
  ),
  WordModel(
    id: 'word-file-system',
    word: 'File System',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'The Command Line (Shell & Files)',
    conversationQ: 'Is our file system encrypted?',
    conversationA: 'Yes, we are using APFS with FileVault enabled to ensure the entire disk is protected at rest.',
  ),
  WordModel(
    id: 'word-ip-address',
    word: 'IP Address',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'What\'s the server\'s IP?',
    conversationA: 'It\'s 192.168.1.50 locally, but we should use its hostname \'api-server\' so we don\'t have to change code if the IP changes.',
  ),
  WordModel(
    id: 'word-dns',
    word: 'DNS',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'The site is down after the migration.',
    conversationA: 'Check the DNS records. The changes might still be propagating to global servers because of the 24-hour TTL.',
  ),
  WordModel(
    id: 'word-domain',
    word: 'Domain',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Did we renew the domain?',
    conversationA: 'Yes, techtake.dev is secured for another 3 years. We also registered the .com version just in case.',
  ),
  WordModel(
    id: 'word-protocol',
    word: 'Protocol',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Which protocol are we using for the real-time chat?',
    conversationA: 'We\'re using WebSockets (WSS) because it\'s a bidirectional protocol that keeps a persistent connection open.',
  ),
  WordModel(
    id: 'word-tcp-ip',
    word: 'TCP/IP',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Why is the file download slow but the ping is fast?',
    conversationA: 'TCP is likely performing \'congestion control\' because it detected some lost packets and is slowing down the stream to ensure reliability.',
  ),
  WordModel(
    id: 'word-router',
    word: 'Router',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Can you see the traffic on the router?',
    conversationA: 'Yes, I\'m checking the routing table to see why packets for the 10.0.0.x range aren\'t being forwarded correctly.',
  ),
  WordModel(
    id: 'word-isp',
    word: 'ISP',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Is the internet slow for everyone?',
    conversationA: 'No, it looks like an outage at our ISP\'s regional hub. We should check their status page.',
  ),
  WordModel(
    id: 'word-vpn',
    word: 'VPN',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Can I access the staging server from home?',
    conversationA: 'Only if you\'re connected to the company VPN. It puts your laptop \'inside\' our private office network.',
  ),
  WordModel(
    id: 'word-firewalls',
    word: 'Firewalls',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Why is the API timing out?',
    conversationA: 'The firewall is blocking port 8080. We need to add an \'allow\' rule for the load balancer\'s IP range.',
  ),
  WordModel(
    id: 'word-port',
    word: 'Port',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Which port is the dev server running on?',
    conversationA: 'It\'s on localhost:3000. Port 80 is already being used by the production proxy.',
  ),
  WordModel(
    id: 'word-gateway',
    word: 'Gateway',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'The server can\'t reach the update repo.',
    conversationA: 'Check the default gateway. If the server doesn\'t know where the \'exit\' is, it can\'t reach anything outside the local subnet.',
  ),
  WordModel(
    id: 'word-mac-address',
    word: 'MAC Address',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Can we block this specific laptop from the WiFi?',
    conversationA: 'Yes, we can blacklist its MAC address in the router settings so it can\'t even connect to the local airwaves.',
  ),
  WordModel(
    id: 'word-subnet',
    word: 'Subnet',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'How the Internet Connects',
    conversationQ: 'Can the DB see the App server?',
    conversationA: 'No, they are on different subnets. We need to configure a VPC peering connection or update the route table.',
  ),
  WordModel(
    id: 'word-client',
    word: 'Client',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'Is the bug on the client or the server?',
    conversationA: 'It\'s the client. The browser console shows it\'s failing to parse the JSON response from the API.',
  ),
  WordModel(
    id: 'word-server',
    word: 'Server',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'The server is at 99% CPU.',
    conversationA: 'It\'s struggling with the encryption overhead. We should move SSL termination to the load balancer to free up the server.',
  ),
  WordModel(
    id: 'word-url',
    word: 'URL',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'The image isn\'t loading.',
    conversationA: 'The URL is relative. It\'s looking for the image at /images/logo.png but it should be /static/logo.png.',
  ),
  WordModel(
    id: 'word-http-https',
    word: 'HTTP/HTTPS',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'Why is the browser saying \'Not Secure\'?',
    conversationA: 'The site is using HTTP. We need to install an SSL certificate to move to HTTPS and encrypt the user\'s connection.',
  ),
  WordModel(
    id: 'word-request',
    word: 'Request',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'What\'s in the request body?',
    conversationA: 'It\'s a JSON object containing the user\'s new password and email address.',
  ),
  WordModel(
    id: 'word-response',
    word: 'Response',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'What\'s the response from the API?',
    conversationA: 'It returned a 200 OK along with a list of all active users in the system.',
  ),
  WordModel(
    id: 'word-status-code',
    word: 'Status Code',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'Why is the login failing?',
    conversationA: 'The server is returning a 401 Unauthorized status code, which means the username or password was wrong.',
  ),
  WordModel(
    id: 'word-header',
    word: 'Header',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'How does the server know I\'m logged in?',
    conversationA: 'We\'re sending an \'Authorization\' header with a Bearer token in every request.',
  ),
  WordModel(
    id: 'word-body',
    word: 'Body',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'Why is the body empty?',
    conversationA: 'It\'s a GET request. GET requests usually don\'t have a body; the parameters are in the URL instead.',
  ),
  WordModel(
    id: 'word-cookies',
    word: 'Cookies',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'Why did I get logged out?',
    conversationA: 'Your session cookie expired. The browser deleted it, so the server doesn\'t recognize you anymore.',
  ),
  WordModel(
    id: 'word-cache',
    word: 'Cache',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'I changed the CSS, but the site looks the same.',
    conversationA: 'Your browser has the old CSS in its cache. Try a hard refresh (Cmd+Shift+R) to clear it and fetch the new version.',
  ),
  WordModel(
    id: 'word-session',
    word: 'Session',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'Is the user session still valid?',
    conversationA: 'Yes, the session ID in the cookie matches the active session in our Redis database.',
  ),
  WordModel(
    id: 'word-ttl',
    word: 'TTL',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Speaking Web (HTTP)',
    conversationQ: 'How long until the DNS update takes effect?',
    conversationA: 'The TTL is set to 3600 seconds, so it should be visible globally within an hour.',
  ),
  WordModel(
    id: 'word-json',
    word: 'JSON',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Can you send me that user data?',
    conversationA: 'Sure, I\'ll export it as a JSON file so you can easily import it into your script.',
  ),
  WordModel(
    id: 'word-xml',
    word: 'XML',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Why is this API so verbose?',
    conversationA: 'It\'s using XML. Every piece of data is wrapped in opening and closing tags, which adds a lot of overhead compared to JSON.',
  ),
  WordModel(
    id: 'word-yaml',
    word: 'YAML',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Is the Kubernetes config correct?',
    conversationA: 'Check the indentation. YAML is strict about spaces, and it looks like the \'ports\' section is one level too deep.',
  ),
  WordModel(
    id: 'word-csv',
    word: 'CSV',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'How should I send you the sales report?',
    conversationA: 'Just export it as a CSV. I can quickly parse it with a Python script.',
  ),
  WordModel(
    id: 'word-key-value-pair',
    word: 'Key-Value Pair',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'How are we storing the user preferences?',
    conversationA: 'It\'s a simple key-value store in Redis. Key is \'user_id\', value is their theme and language settings.',
  ),
  WordModel(
    id: 'word-syntax',
    word: 'Syntax',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Why won\'t the code run?',
    conversationA: 'It\'s a syntax error. You forgot the closing parenthesis on line 42.',
  ),
  WordModel(
    id: 'word-parsing',
    word: 'Parsing',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Is the API response ready?',
    conversationA: 'Almost, the code is currently parsing the 5MB JSON file into our internal data model.',
  ),
  WordModel(
    id: 'word-string',
    word: 'String',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Why is the age comparison failing?',
    conversationA: 'Because \'25\' is currently a string. You need to convert it to a number before you can check if it\'s greater than 18.',
  ),
  WordModel(
    id: 'word-integer',
    word: 'Integer',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'What\'s the product ID?',
    conversationA: 'It\'s an integer, currently 1042. It increments by 1 for every new product.',
  ),
  WordModel(
    id: 'word-boolean',
    word: 'Boolean',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Is the user an admin?',
    conversationA: 'Check the \'isAdmin\' boolean. If it\'s true, show them the dashboard; if false, redirect them.',
  ),
  WordModel(
    id: 'word-array',
    word: 'Array',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'Where are the search results?',
    conversationA: 'They are stored in an array. We can use a loop to display each item in the list.',
  ),
  WordModel(
    id: 'word-objects',
    word: 'Objects',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'How do we pass the user data to the function?',
    conversationA: 'Just pass the whole user object. It contains all the info the function needs.',
  ),
  WordModel(
    id: 'word-serialization',
    word: 'Serialization',
    ...
    category: 'Phase 1: The Foundation',
    conceptId: 'Data Formats',
    conversationQ: 'How do we save the game state?',
    conversationA: 'We\'ll serialize the player object into a JSON string and save it to a file.',
  ),
  WordModel(
    id: 'word-linked-list',
    word: 'Linked List',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'Why not use an array here?',
    conversationA: 'We\'re doing thousands of insertions at the beginning of the list. In an array, that\'s O(n) per insert. In a linked list, it\'s O(1).',
  ),
  WordModel(
    id: 'word-stack',
    word: 'Stack',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How does the \'Back\' button work in the browser?',
    conversationA: 'It\'s a stack. Every page you visit is \'pushed\' on top. When you go back, the current page is \'popped\' off.',
  ),
  WordModel(
    id: 'word-queue',
    word: 'Queue',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'Why is the email notification delayed?',
    conversationA: 'The email is stuck in a processing queue. There are 5,000 tasks ahead of it, so it\'s waiting its turn.',
  ),
  WordModel(
    id: 'word-hash-map-dictionary-',
    word: 'Hash Map (Dictionary)',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How can we speed up the username check?',
    conversationA: 'Store all usernames in a hash map. Instead of searching the whole DB, we can check if the key exists instantly.',
  ),
  WordModel(
    id: 'word-binary-tree',
    word: 'Binary Tree',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'Is the database index using a tree?',
    conversationA: 'Yes, it uses a B-Tree (a variation of a binary tree) to allow us to find any record in millions of rows in just a few steps.',
  ),
  WordModel(
    id: 'word-graph',
    word: 'Graph',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How does Facebook know who my \'suggested friends\' are?',
    conversationA: 'They use a graph database. They look for nodes (people) that are connected to you through only two edges (friends of friends).',
  ),
  WordModel(
    id: 'word-node',
    word: 'Node',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'What\'s in the current node?',
    conversationA: 'It holds the user ID and a \'next\' pointer that leads to the next user in the list.',
  ),
  WordModel(
    id: 'word-pointer',
    word: 'Pointer',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'Why did it crash?',
    conversationA: 'It was a null pointer exception. We tried to read data from an address that didn\'t exist.',
  ),
  WordModel(
    id: 'word-heap',
    word: 'Heap',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How do we handle the high-priority support tickets first?',
    conversationA: 'We\'ll store them in a Max-Heap based on their urgency score. The most urgent one will always be at the top.',
  ),
  WordModel(
    id: 'word-vector',
    word: 'Vector',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How many items can the list hold?',
    conversationA: 'It\'s a vector, so it will automatically expand its memory as we add more items.',
  ),
  WordModel(
    id: 'word-matrix',
    word: 'Matrix',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How are the image filters applied?',
    conversationA: 'We represent the image as a matrix of RGB values and multiply it by a \'convolution matrix\' to blur or sharpen it.',
  ),
  WordModel(
    id: 'word-set',
    word: 'Set',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Data Structures (Containers)',
    conversationQ: 'How do we remove duplicates from the email list?',
    conversationA: 'Just convert the list to a Set. It will automatically discard any email addresses it has already seen.',
  ),
  WordModel(
    id: 'word-sorting',
    word: 'Sorting',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'Can we show the cheapest products first?',
    conversationA: 'Yes, we just need to run a sort algorithm on the price field before sending the data to the frontend.',
  ),
  WordModel(
    id: 'word-recursion',
    word: 'Recursion',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How do we count all the files in all subfolders?',
    conversationA: 'We\'ll use a recursive function. It will count the files in the current folder, then call itself for every subfolder it finds.',
  ),
  WordModel(
    id: 'word-binary-search',
    word: 'Binary Search',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'Why is the search so fast even with a billion rows?',
    conversationA: 'We\'re using binary search on the index. It only takes about 30 steps to find any item in a billion rows.',
  ),
  WordModel(
    id: 'word-iteration',
    word: 'Iteration',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How do we apply the discount to all products?',
    conversationA: 'We\'ll iterate through the product array and update the \'price\' field for each item in a loop.',
  ),
  WordModel(
    id: 'word-brute-force',
    word: 'Brute Force',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How should we find the shortest path between these 10 cities?',
    conversationA: 'With only 10 cities, a brute force search of all possible routes is fast enough to find the absolute best one.',
  ),
  WordModel(
    id: 'word-divide-and-conquer',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How does Merge Sort work?',
    conversationA: 'It uses divide and conquer. It splits the list into single items, then merges them back together in the correct order.',
  ),
  WordModel(
    id: 'word-dynamic-programming',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'Why is this pathfinding so slow?',
    conversationA: 'It\'s recalculating the distance for the same intersections. We should use dynamic programming to cache those intermediate results.',
  ),
  WordModel(
    id: 'word-greedy',
    word: 'Greedy',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How should the cashier give change?',
    conversationA: 'Use a greedy approach: always give the largest coin possible first. It\'s fast and usually results in the fewest coins.',
  ),
  WordModel(
    id: 'word-backtracking',
    word: 'Backtracking',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How does the computer solve the maze?',
    conversationA: 'It uses backtracking. It tries every turn, and when it hits a wall, it backs up to the last open turn and tries again.',
  ),
  WordModel(
    id: 'word-traversal',
    word: 'Traversal',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'How do we find the user with ID 50 in the tree?',
    conversationA: 'We\'ll perform a traversal. We start at the top and check every node until we find the match.',
  ),
  WordModel(
    id: 'word-memoization',
    word: 'Memoization',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Algorithms (Recipes)',
    conversationQ: 'Why is the dashboard lagging when I filter?',
    conversationA: 'The data transformation is running on every render. We should memoize the result so it only recalculates when the raw data actually changes.',
  ),
  WordModel(
    id: 'word-big-o-notation',
    word: 'Big O Notation',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Is this code efficient?',
    conversationA: 'In terms of Big O, it\'s O(n²). That\'s fine for 100 items, but it will crawl if we ever reach 100,000 items.',
  ),
  WordModel(
    id: 'word-time-complexity',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Why is the app slow?',
    conversationA: 'The time complexity of the search is linear, meaning it checks every item. We need to index the data to make it logarithmic.',
  ),
  WordModel(
    id: 'word-space-complexity',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Why did the server crash on the big file?',
    conversationA: 'The algorithm has high space complexity. It tried to copy the whole 4GB file into RAM instead of processing it line-by-line.',
  ),
  WordModel(
    id: 'word-constant-time-o-1-',
    word: 'Constant Time O(1)',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'How fast is the ID lookup?',
    conversationA: 'It\'s O(1). Whether we have ten users or ten million, finding a user by ID takes exactly the same amount of time.',
  ),
  WordModel(
    id: 'word-linear-time-o-n-',
    word: 'Linear Time O(n)',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Can we find the user by their email?',
    conversationA: 'Yes, but the email isn\'t indexed, so it\'s an O(n) search. We\'ll have to check every single user until we find a match.',
  ),
  WordModel(
    id: 'word-logarithmic-o-log-n-',
    word: 'Logarithmic O(log n)',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Is the search efficient?',
    conversationA: 'Yes, it\'s O(log n). Even if the user count grows to a billion, we can find anyone in about 30 steps.',
  ),
  WordModel(
    id: 'word-exponential',
    word: 'Exponential',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Can we find the absolute best delivery route for these 50 stops?',
    conversationA: 'Not exactly. The complexity is exponential. It would take billions of years to check every route. We\'ll use a \'Greedy\' approach instead.',
  ),
  WordModel(
    id: 'word-worst-case',
    word: 'Worst Case',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Is the search always fast?',
    conversationA: 'Usually, but in the worst case (if the item is the very last one), it takes O(n) time. We should ensure the UI has a loading state.',
  ),
  WordModel(
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Should we optimize the login function?',
    conversationA: 'No, it already takes less than 50ms. We should focus on optimizing the product search, which currently takes 2 seconds.',
  ),
  WordModel(
    id: 'word-bottleneck',
    word: 'Bottleneck',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Why is the page slow to load?',
    conversationA: 'The database query is the bottleneck. It\'s taking 90% of the total request time. We need an index on the \'category\' column.',
  ),
  WordModel(
    id: 'word-trade-offs',
    word: 'Trade-offs',
    ...
    category: 'Phase 2: The Logic',
    conceptId: 'Complexity (Big O)',
    conversationQ: 'Should we cache the entire database in RAM?',
    conversationA: 'It\'s a trade-off. It will make searches instant, but it will cost thousands of dollars more in server fees every month.',
  ),
  WordModel(
    id: 'word-oop-object-oriented-',
    word: 'OOP (Object Oriented)',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Is OOP dying in favor of Functional Programming?',
    conversationA: 'No, they\'re merging. Modern languages like TypeScript allow for a \'Functional-ish\' OOP approach where we use classes for structure but maintain clean data.',
  ),
  WordModel(
    id: 'word-functional-programming',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Why use \'map\' instead of a \'for\' loop?',
    conversationA: 'Using \'map\' is more declarative. It tells the computer *what* to do (transform this list) rather than *how* to do it step-by-step.',
  ),
  WordModel(
    id: 'word-imperative',
    word: 'Imperative',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'How is this list being built?',
    conversationA: 'It\'s an imperative loop. We\'re manually creating an empty array and pushing items into it one by one.',
  ),
  WordModel(
    id: 'word-declarative',
    word: 'Declarative',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Why is React considered declarative?',
    conversationA: 'Because you just describe what the UI should look like for a given state, and React handles the messy steps of updating the actual screen.',
  ),
  WordModel(
    id: 'word-class',
    word: 'Class',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Should we make \'Product\' a class?',
    conversationA: 'Yes, if the Product has its own logic (like \'calculateDiscount()\'). If it\'s just raw data, a simple Interface is better.',
  ),
  WordModel(
    id: 'word-object',
    word: 'Object',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'What\'s in the \'currentUser\' object?',
    conversationA: 'It has \'name: Jane\', \'email: jane@test.com\', and a method to \'logOut()\'.',
  ),
  WordModel(
    id: 'word-inheritance',
    word: 'Inheritance',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Should \'Manager\' inherit from \'Employee\'?',
    conversationA: 'Yes, because every Manager *is* an Employee and shares the same payroll logic, but with extra \'approveExpenses\' powers.',
  ),
  WordModel(
    id: 'word-polymorphism',
    word: 'Polymorphism',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'How does the \'render()\' function handle different components?',
    conversationA: 'It\'s polymorphism. Every component has a \'render\' method, so the engine just calls it without caring if it\'s a Button or a Header.',
  ),
  WordModel(
    id: 'word-encapsulation',
    word: 'Encapsulation',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Why can\'t I change the user\'s password directly?',
    conversationA: 'It\'s encapsulated. You have to use the \'updatePassword()\' method so the class can validate the new password before saving it.',
  ),
  WordModel(
    id: 'word-abstraction',
    word: 'Abstraction',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Why use an ORM instead of raw SQL?',
    conversationA: 'It\'s a layer of abstraction. It lets us work with JavaScript objects and handles all the messy database-specific SQL for us.',
  ),
  WordModel(
    id: 'word-immutability',
    word: 'Immutability',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Why not just update the array directly?',
    conversationA: 'If we modify the array, React might not realize the data has changed. We need to create a new array so the UI re-renders correctly.',
  ),
  WordModel(
    id: 'word-pure-function',
    word: 'Pure Function',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Is this function pure?',
    conversationA: 'No, it reads from a global \'config\' variable. If the config changes, the function returns a different result for the same input.',
  ),
  WordModel(
    id: 'word-side-effect',
    word: 'Side Effect',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Programming Paradigms',
    conversationQ: 'Why is the user being logged out randomly?',
    conversationA: 'The \'getUser\' function has a side effect: it secretly clears the session if it finds an error. We should move that logic to a separate handler.',
  ),
  WordModel(
    id: 'word-solid',
    word: 'SOLID',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'How does Dependency Inversion help us with testing?',
    conversationA: 'By depending on abstractions rather than concrete classes, we can easily inject \'mock\' services into our tests instead of calling real databases.',
  ),
  WordModel(
    id: 'word-dry-don-t-repeat-yourself-',
    word: 'DRY (Don\'t Repeat Yourself)',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Should we combine these two forms into one component?',
    conversationA: 'They look similar now, but the \'Edit\' form will soon need 5 extra fields. Forcing them into one component would break DRY eventually. Let\'s keep them separate.',
  ),
  WordModel(
    id: 'word-kiss-keep-it-simple-',
    word: 'KISS (Keep It Simple)',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Should we use a state management library for this toggle?',
    conversationA: 'No, let\'s KISS. A simple React \'useState\' hook is enough. We don\'t need a massive library for one button.',
  ),
  WordModel(
    id: 'word-yagni-you-ain-t-gonna-need-it-',
    word: 'YAGNI (You Ain\'t Gonna Need It)',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Should we add multi-language support to the app now?',
    conversationA: 'YAGNI. We only have users in New York right now. Let\'s wait until we actually launch in other countries.',
  ),
  WordModel(
    id: 'word-clean-code',
    word: 'Clean Code',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Why did you rename \'fn1\' to \'calculateMonthlyTax\'?',
    conversationA: 'To make the code cleaner. Now, anyone reading the script knows exactly what that function is doing without needing a comment.',
  ),
  WordModel(
    id: 'word-separation-of-concerns',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Why did we move the API calls out of the Component file?',
    conversationA: 'Separation of concerns. The component should only worry about the UI. The \'service\' file handles the messy networking details.',
  ),
  WordModel(
    id: 'word-coupling',
    word: 'Coupling',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Why is the build failing after I changed the user model?',
    conversationA: 'The checkout service is tightly coupled to the user model. We need to decouple them so the checkout doesn\'t care about the user\'s middle name.',
  ),
  WordModel(
    id: 'word-cohesion',
    word: 'Cohesion',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Should we move the \'formatCurrency\' function to the \'Auth\' service?',
    conversationA: 'No, that would lower the cohesion of the Auth service. It belongs in a \'Utilities\' or \'Finance\' module.',
  ),
  WordModel(
    id: 'word-dependency-injection',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'How do we test the email service without actually sending 1,000 emails?',
    conversationA: 'We\'ll use dependency injection. We\'ll inject a \'MockEmailProvider\' that just logs to the console instead of calling the real API.',
  ),
  WordModel(
    id: 'word-refactoring',
    word: 'Refactoring',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Is the new feature ready?',
    conversationA: 'It\'s working, but the code is a mess. I need one more hour to refactor it before I open the Pull Request.',
  ),
  WordModel(
    id: 'word-technical-debt',
    word: 'Technical Debt',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Code Quality Principles',
    conversationQ: 'Why is it taking so long to add this simple button?',
    conversationA: 'We have too much technical debt. The codebase is so messy that adding even a small feature causes unexpected crashes elsewhere.',
  ),
  WordModel(
    id: 'word-horizontal-scaling',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Our server is crashing on Black Friday. What should we do?',
    conversationA: 'Let\'s spin up 5 more instances of the app. Our load balancer will automatically distribute the traffic across them.',
  ),
  WordModel(
    id: 'word-vertical-scaling',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'The database is slow. Can we add more RAM?',
    conversationA: 'Yes, we\'ll vertically scale it from 16GB to 64GB tonight. That should fix the memory bottleneck for now.',
  ),
  WordModel(
    id: 'word-load-balancing',
    word: 'Load Balancing',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Is the site down?',
    conversationA: 'One of our servers crashed, but the load balancer detected it and is now sending all traffic to the remaining healthy servers.',
  ),
  WordModel(
    id: 'word-caching',
    word: 'Caching',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Why is the page loading so fast now?',
    conversationA: 'We\'re caching the homepage HTML in memory. Instead of rebuilding it for every user, we just send the saved version.',
  ),
  WordModel(
    id: 'word-cdn-content-delivery-network-',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'The site is slow in Japan but fast in the US.',
    conversationA: 'We\'re serving everything from Virginia. We should enable a CDN so our users in Tokyo can fetch assets from a local server.',
  ),
  WordModel(
    id: 'word-proxy',
    word: 'Proxy',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Why is my IP showing as being in Germany?',
    conversationA: 'You\'re connected through a proxy server in Frankfurt. The website you\'re visiting only sees the proxy\'s location, not yours.',
  ),
  WordModel(
    id: 'word-reverse-proxy',
    word: 'Reverse Proxy',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Where is the SSL certificate installed?',
    conversationA: 'It\'s on the Nginx reverse proxy. It handles the \'HTTPS\' part and then sends plain \'HTTP\' traffic to our app servers inside the private network.',
  ),
  WordModel(
    id: 'word-high-availability',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'What is our \'uptime\' target?',
    conversationA: 'We are aiming for \'Four Nines\' (99.99%) high availability. This means we can only afford about 52 minutes of downtime per year.',
  ),
  WordModel(
    id: 'word-fault-tolerance',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'What happens if the main database goes down?',
    conversationA: 'Our system is fault-tolerant. It will automatically switch to the \'Read Replica\' and promote it to be the new main database instantly.',
  ),
  WordModel(
    id: 'word-single-point-of-failure-spof-',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Is our load balancer a SPOF?',
    conversationA: 'Yes, if that one instance goes down, we\'re offline. We should set up a \'High Availability\' pair of load balancers.',
  ),
  WordModel(
    id: 'word-cap-theorem',
    word: 'CAP Theorem',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'Should we use MongoDB or Postgres?',
    conversationA: 'For the shopping cart, we want Availability (AP), so MongoDB is great. For the payment processing, we need strict Consistency (CP), so Postgres is better.',
  ),
  WordModel(
    id: 'word-consistent-hashing',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'System Design Fundamentals',
    conversationQ: 'How do we add more cache nodes without a performance drop?',
    conversationA: 'We\'re using consistent hashing. Adding a node only invalidates a small fraction of the cache, so the system stays fast.',
  ),
  WordModel(
    id: 'word-unit-test',
    word: 'Unit Test',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'Why is the build failing?',
    conversationA: 'The unit test for \'calculateTax\' is failing. It returned \$10.01 instead of \$10.00 for the sample input.',
  ),
  WordModel(
    id: 'word-integration-test',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'The login function works locally, so why is it failing in the test environment?',
    conversationA: 'The integration test caught a bug: the app is using the wrong database credentials in the staging environment.',
  ),
  WordModel(
    id: 'word-end-to-end-e2e-',
    word: 'End-to-End (E2E)',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'How do we know the new update didn\'t break the checkout?',
    conversationA: 'The E2E test suite just finished. It successfully \'bought\' an item on our staging site, so we\'re good to deploy.',
  ),
  WordModel(
    id: 'word-tdd-test-driven-development-',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'Why start with the test?',
    conversationA: 'With TDD, I\'m defining the \'Success\' state first. It prevents me from writing unnecessary code and guarantees my logic is tested.',
  ),
  WordModel(
    id: 'word-mocking',
    word: 'Mocking',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'Are the tests slow today?',
    conversationA: 'No, we\'re mocking the network calls. The tests run in milliseconds because they aren\'t actually waiting for the internet.',
  ),
  WordModel(
    id: 'word-stubbing',
    word: 'Stubbing',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'How do we test what happens when the API fails?',
    conversationA: 'We\'ll stub the API service to return a \'500 Server Error\' and check if our UI shows the correct alert message.',
  ),
  WordModel(
    id: 'word-code-coverage',
    word: 'Code Coverage',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'Is the new module safe to deploy?',
    conversationA: 'Our code coverage is at 92%. Every major logic path has been touched by a test, so we\'re confident.',
  ),
  WordModel(
    id: 'word-regression-testing',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'The checkout is broken, but I only changed the logo!',
    conversationA: 'The regression tests caught it. The logo change accidentally deleted a CSS class that the checkout button needed to be visible.',
  ),
  WordModel(
    id: 'word-smoke-test',
    word: 'Smoke Test',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'Is the production release okay?',
    conversationA: 'The smoke tests passed. The home page is up and we can reach the login screen. Now we\'ll run the full E2E suite.',
  ),
  WordModel(
    id: 'word-flaky-test',
    word: 'Flaky Test',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'The build failed again, should I just re-run it?',
    conversationA: 'No, that E2E test is flaky. We need to find the race condition and fix it so we can trust our results again.',
  ),
  WordModel(
    id: 'word-black-box-vs-white-box',
    word: 'Black Box vs. White Box',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Testing & Reliability Strategies',
    conversationQ: 'How are we testing the new search?',
    conversationA: 'We\'re doing both. White Box for the relevance algorithm and Black Box to make sure the results look good on mobile.',
  ),
  WordModel(
    id: 'word-synchronous',
    word: 'Synchronous',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Why did the app freeze for 5 seconds?',
    conversationA: 'It was running a synchronous file read on the main thread. We should switch to an asynchronous version to keep the UI responsive.',
  ),
  WordModel(
    id: 'word-asynchronous',
    word: 'Asynchronous',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'How do we fetch the data without lagging the page?',
    conversationA: 'We\'ll use an asynchronous \'fetch\' call. The page will keep running smoothly while the data is being downloaded in the background.',
  ),
  WordModel(
    id: 'word-blocking',
    word: 'Blocking',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Why is the \'Submit\' button stuck in the \'Down\' position?',
    conversationA: 'The validation logic is blocking the main thread. We should move that calculation to a separate worker so the button feels snappy.',
  ),
  WordModel(
    id: 'word-non-blocking',
    word: 'Non-blocking',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Can Node.js handle thousands of connections at once?',
    conversationA: 'Yes, because it\'s non-blocking. It doesn\'t wait for one request to finish before starting the next one; it just juggle all of them.',
  ),
  WordModel(
    id: 'word-callback',
    word: 'Callback',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'How do we handle the API response?',
    conversationA: 'We\'ll pass a callback function to the \'getData\' tool. It will run automatically as soon as the data arrives.',
  ),
  WordModel(
    id: 'word-promise',
    word: 'Promise',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'What does the \'fetch\' function return?',
    conversationA: 'It returns a Promise. We use \'await\' to wait for it to resolve into the actual data.',
  ),
  WordModel(
    id: 'word-future',
    word: 'Future',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'How do we wait for the database in Flutter?',
    conversationA: 'The database query returns a Future. We\'ll use a \'FutureBuilder\' widget to show a spinner until the data arrives.',
  ),
  WordModel(
    id: 'word-event-loop',
    word: 'Event Loop',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Why didn\'t my \'setTimeout\' run exactly at 1 second?',
    conversationA: 'The event loop was busy finishing a long calculation. It only got back to your timer after it finished the other work.',
  ),
  WordModel(
    id: 'word-concurrency',
    word: 'Concurrency',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Is Node.js concurrent?',
    conversationA: 'Yes, it\'s highly concurrent. It can handle thousands of open connections by juggling them on the event loop.',
  ),
  WordModel(
    id: 'word-parallelism',
    word: 'Parallelism',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'How do we speed up the video export?',
    conversationA: 'We\'ll use parallelism. We\'ll split the video into 8 chunks and render each chunk on a separate CPU core at the same time.',
  ),
  WordModel(
    id: 'word-race-condition',
    word: 'Race Condition',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Why is the counter showing 105 instead of 200?',
    conversationA: 'It\'s a race condition. Two updates happened at once, and one \'clobbered\' the other because it read an old value before the first one finished saving.',
  ),
  WordModel(
    id: 'word-thread-safety',
    word: 'Thread Safety',
    ...
    category: 'Phase 3: The Concepts',
    conceptId: 'Asynchronous Concepts',
    conversationQ: 'Is this logging library safe?',
    conversationA: 'Yes, it\'s thread-safe. It uses a internal queue to ensure that logs from different threads don\'t get scrambled together in the file.',
  ),
  WordModel(
    id: 'word-html',
    word: 'HTML',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Is the page accessible?',
    conversationA: 'Not yet. We need to use semantic HTML like <header> and <main> so screen readers can understand the layout.',
  ),
  WordModel(
    id: 'word-css',
    word: 'CSS',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'How do we make the button blue?',
    conversationA: 'We\'ll add a CSS rule that targets the \'btn\' class and sets the \'background-color\' property to blue.',
  ),
  WordModel(
    id: 'word-javascript',
    word: 'JavaScript',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'How does the search update as I type?',
    conversationA: 'It\'s using a JavaScript event listener that triggers an API call every time you press a key.',
  ),
  WordModel(
    id: 'word-dom',
    word: 'DOM',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'How do we hide the popup?',
    conversationA: 'We\'ll find the popup element in the DOM and change its style to \'display: none\'.',
  ),
  WordModel(
    id: 'word-framework',
    word: 'Framework',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Which framework should we use?',
    conversationA: 'We\'ll use React. It has a massive ecosystem and the best documentation for our team to get up to speed quickly.',
  ),
  WordModel(
    id: 'word-library',
    word: 'Library',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'How do we format the dates?',
    conversationA: 'We\'ll use the \'date-fns\' library. It has simple functions to turn \'2023-01-01\' into \'January 1st, 2023\'.',
  ),
  WordModel(
    id: 'word-responsive',
    word: 'Responsive',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Does the menu work on iPhone?',
    conversationA: 'Yes, we used a responsive design. On small screens, the horizontal menu automatically collapses into a \'Hamburger\' icon.',
  ),
  WordModel(
    id: 'word-spa',
    word: 'SPA',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Why is navigation so fast?',
    conversationA: 'It\'s an SPA. The browser isn\'t actually downloading a new page; JavaScript is just swapping out the middle section of the screen.',
  ),
  WordModel(
    id: 'word-ui',
    word: 'UI',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'What do you think of the new UI?',
    conversationA: 'The buttons are much clearer now, and the emerald green accent gives it a high-end technical feel.',
  ),
  WordModel(
    id: 'word-ux',
    word: 'UX',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Why did we remove that extra confirmation step?',
    conversationA: 'To improve the UX. Users found it annoying to click \'Yes\' three times just to delete a simple note.',
  ),
  WordModel(
    id: 'word-accessibility-a11y-',
    word: 'Accessibility (a11y)',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Is the site a11y compliant?',
    conversationA: 'Mostly, but we still need to add \'alt\' text to our images so blind users know what they are looking at.',
  ),
  WordModel(
    id: 'word-asset',
    word: 'Asset',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Frontend: The Glass',
    conversationQ: 'Why is the page so slow to load?',
    conversationA: 'The header image is a 5MB PNG. We should convert it to an optimized WebP asset to save bandwidth.',
  ),
  WordModel(
    id: 'word-server-side',
    word: 'Server-side',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'Where should we calculate the final bill?',
    conversationA: 'Server-side. If we do it on the client, a user could secretly change the JavaScript and give themselves a 99% discount.',
  ),
  WordModel(
    id: 'word-logic',
    word: 'Logic',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'Why did the coupon fail?',
    conversationA: 'The logic in the backend says coupons only work on Tuesdays. Today is Wednesday, so the code rejected it.',
  ),
  WordModel(
    id: 'word-environment-variables',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'How do I connect to the local database?',
    conversationA: 'Update your \'.env\' file. Set the DB_URL variable to \'localhost:5432\' and the app will pick it up automatically.',
  ),
  WordModel(
    id: 'word-api',
    word: 'API',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'How does the mobile app get the user list?',
    conversationA: 'It makes a request to our backend API, which returns the list in JSON format.',
  ),
  WordModel(
    id: 'word-endpoint',
    word: 'Endpoint',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'Which endpoint should I use to delete a post?',
    conversationA: 'Send a DELETE request to the \'/posts/:id\' endpoint with the ID of the post you want to remove.',
  ),
  WordModel(
    id: 'word-crud',
    word: 'CRUD',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'Is the new module finished?',
    conversationA: 'Almost, the basic CRUD operations are working. I can create and view notes, but I still need to finish the \'Update\' feature.',
  ),
  WordModel(
    id: 'word-middleware',
    word: 'Middleware',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'How do we protect the admin routes?',
    conversationA: 'We\'ll add a \'CheckAdmin\' middleware. It will look at the session and block anyone who isn\'t an admin before they even reach the sensitive logic.',
  ),
  WordModel(
    id: 'word-authentication',
    word: 'Authentication',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'Is the user authenticated?',
    conversationA: 'Yes, they successfully provided the correct password and completed the two-factor authentication check.',
  ),
  WordModel(
    id: 'word-cron-job',
    word: 'Cron Job',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'When does the cache refresh?',
    conversationA: 'There\'s a cron job that runs every hour to clear old entries and fetch fresh data from the external API.',
  ),
  WordModel(
    id: 'word-script',
    word: 'Script',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'How did we get all the user photos into the new folder?',
    conversationA: 'I wrote a quick Python script that loops through the old folder and copies them over to the new one.',
  ),
  WordModel(
    id: 'word-runtime',
    word: 'Runtime',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Backend: The Engine',
    conversationQ: 'Which version of Node are we using?',
    conversationA: 'We\'re using the latest LTS (Long Term Support) runtime to ensure we have the best performance and security.',
  ),
  WordModel(
    id: 'word-rest',
    word: 'REST',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'Should we use PUT or PATCH for updates?',
    conversationA: 'Use PUT if we\'re replacing the whole profile; use PATCH if we\'re only updating one field like the \'bio\'.',
  ),
  WordModel(
    id: 'word-graphql',
    word: 'GraphQL',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'Why use GraphQL for the dashboard?',
    conversationA: 'The dashboard needs data from 5 different tables. With GraphQL, we can get everything in one single request instead of five separate API calls.',
  ),
  WordModel(
    id: 'word-webhook',
    word: 'Webhook',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'How do we know if the payment was successful?',
    conversationA: 'Stripe will send a webhook to our \'/payment-complete\' endpoint as soon as the credit card is charged.',
  ),
  WordModel(
    id: 'word-websocket',
    word: 'Websocket',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'How does the stock price update instantly?',
    conversationA: 'We have an open WebSocket connection. The server pushes the new price to the browser the millisecond it changes on the market.',
  ),
  WordModel(
    id: 'word-soap',
    word: 'SOAP',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'Why are we still using XML for the bank integration?',
    conversationA: 'They are using a legacy SOAP API. It\'s frustrating to work with, but it\'s the only way they allow us to transfer funds.',
  ),
  WordModel(
    id: 'word-payload',
    word: 'Payload',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'What\'s in the webhook payload?',
    conversationA: 'It contains the user\'s ID, the amount they paid, and the timestamp of the transaction.',
  ),
  WordModel(
    id: 'word-integration',
    word: 'Integration',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'How do we handle the shipping labels?',
    conversationA: 'We\'ll build an integration with the UPS API. When a user buys an item, our system will automatically request a label from them.',
  ),
  WordModel(
    id: 'word-rate-limit',
    word: 'Rate Limit',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'Why is the script getting 429 errors?',
    conversationA: 'We hit the API rate limit. We\'re making more than 100 requests per minute, so the server is blocking us for an hour.',
  ),
  WordModel(
    id: 'word-api-key',
    word: 'API Key',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'Where do I put the OpenAI key?',
    conversationA: 'Add it to your \'.env\' file. The code will read it from there instead of having the secret string in the source code.',
  ),
  WordModel(
    id: 'word-documentation',
    word: 'Documentation',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'How do I use the \'search\' feature?',
    conversationA: 'Check the API documentation. It has a section on \'Searching\' with examples of all the parameters you can use.',
  ),
  WordModel(
    id: 'word-throttling',
    word: 'Throttling',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'How Systems Talk (APIs)',
    conversationQ: 'Why is the API taking 2 seconds suddenly?',
    conversationA: 'The server is throttling us because we\'re nearing our monthly usage cap. It\'s slowing us down to save bandwidth.',
  ),
  WordModel(
    id: 'word-monolith',
    word: 'Monolith',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'Should we switch to microservices?',
    conversationA: 'Not yet. We\'re a team of three. The complexity of microservices would slow us down more than the monolith helps us.',
  ),
  WordModel(
    id: 'word-microservices',
    word: 'Microservices',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'Why did the site stay up during the database crash?',
    conversationA: 'We use microservices. Only the \'Comments\' service was down; the \'Search\' and \'Purchase\' services were completely unaffected.',
  ),
  WordModel(
    id: 'word-decoupling',
    word: 'Decoupling',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'How do we send the welcome email without slowing down the signup?',
    conversationA: 'We\'ll decouple them. The signup service will just \'Post a message\' to a queue and finish immediately. A separate service will watch that queue and send the email later.',
  ),
  WordModel(
    id: 'word-service-mesh',
    word: 'Service Mesh',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'How do we encrypt traffic between services?',
    conversationA: 'We\'ll use our Service Mesh. It automatically handles \'Mutual TLS\' for all internal traffic without us changing a single line of code.',
  ),
  WordModel(
    id: 'word-granularity',
    word: 'Granularity',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'Should the \'Change Password\' feature be its own microservice?',
    conversationA: 'No, that\'s too fine-grained. It should be part of the \'Identity\' service. We don\'t want to manage a whole server just for one function.',
  ),
  WordModel(
    id: 'word-modular',
    word: 'Modular',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'Can we reuse the login logic in the new app?',
    conversationA: 'Yes, we built it as a separate module, so we can just drop it into the new project without changing anything.',
  ),
  WordModel(
    id: 'word-distributed-tracing',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'Why did that one request take 10 seconds?',
    conversationA: 'Looking at the distributed trace, I can see that the \'Auth\' service was fast, but it spent 9 seconds waiting for a response from the \'Legacy DB\' service.',
  ),
  WordModel(
    id: 'word-event-driven',
    word: 'Event-Driven',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'How do we update the inventory after a sale?',
    conversationA: 'Our system is event-driven. When a sale happens, it emits a \'SaleSuccess\' event. The inventory service hears this and automatically decrements the stock.',
  ),
  WordModel(
    id: 'word-message-queue',
    word: 'Message Queue',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'The site is slow during the newsletter blast.',
    conversationA: 'We should move the email sending to a message queue. That way, the admin clicks \'Send\' once, and the background workers handle the 50,000 emails slowly without lagging the site.',
  ),
  WordModel(
    id: 'word-pub-sub',
    word: 'Pub/Sub',
    ...
    category: 'Phase 4: The Application',
    conceptId: 'Patterns: Mono vs. Micro',
    conversationQ: 'How do we update the price for all 10,000 active traders?',
    conversationA: 'We\'ll use a Pub/Sub model. The server publishes the new price to the \'BTC-Updates\' channel, and every connected browser receives it instantly.',
  ),
  WordModel(
    id: 'word-sql',
    word: 'SQL',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Can we handle this data transformation in SQL or should we do it in the application code?',
    conversationA: 'Let\'s stick to SQL for this. The database engine is highly optimized for set-based operations, and it saves us the network overhead of pulling raw data into the app.',
  ),
  WordModel(
    id: 'word-table',
    word: 'Table',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Should we add the user\'s address to the Users table?',
    conversationA: 'No, it\'s better to create a separate \'Addresses\' table. Users can have multiple addresses, and this keeps our schema normalized.',
  ),
  WordModel(
    id: 'word-schema',
    word: 'Schema',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Is the database schema ready for the new feature?',
    conversationA: 'Almost. I need to finalize the relationship between the \'Subscriptions\' and \'Invoices\' tables to ensure we don\'t have orphaned records.',
  ),
  WordModel(
    id: 'word-row',
    word: 'Row',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'How many rows are in the logs table?',
    conversationA: 'We\'re currently at 10 million rows. We should look into archiving or partitioning the table to keep query speeds up.',
  ),
  WordModel(
    id: 'word-column',
    word: 'Column',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Should we add a \'last_login\' column to the users table?',
    conversationA: 'Yes, it\'s a simple timestamp and highly relevant for our engagement metrics.',
  ),
  WordModel(
    id: 'word-primary-key',
    word: 'Primary Key',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Why use a UUID as the primary key instead of an integer?',
    conversationA: 'UUIDs are better for distributed systems where we don\'t want collisions when merging data from different regions.',
  ),
  WordModel(
    id: 'word-foreign-key',
    word: 'Foreign Key',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'The database won\'t let me delete this user.',
    conversationA: 'That\'s because of a foreign key constraint. The user has existing orders, and the database is preventing us from creating \'orphaned\' data.',
  ),
  WordModel(
    id: 'word-join',
    word: 'Join',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'How do we show the customer name on the order summary?',
    conversationA: 'We\'ll perform an \'INNER JOIN\' between the Orders and Customers tables on the \'customer_id\' field.',
  ),
  WordModel(
    id: 'word-acid',
    word: 'ACID',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Does our new NoSQL database support ACID?',
    conversationA: 'It supports ACID at the document level, but for multi-document transactions, we need to be careful about how we structure our logic.',
  ),
  WordModel(
    id: 'word-query',
    word: 'Query',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Why is the search query taking so long?',
    conversationA: 'It\'s performing a full table scan because the \'title\' column isn\'t indexed. We should add an index to speed it up.',
  ),
  WordModel(
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Should we normalize the product categories?',
    conversationA: 'Yes, moving categories to their own table prevents us from having to type \'Electronics\' a thousand times and makes it easier to rename them later.',
  ),
  WordModel(
    id: 'word-migration',
    word: 'Migration',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Relational DBs (SQL)',
    conversationQ: 'Did you run the migrations?',
    conversationA: 'Not yet. I need to pull your latest code first so the migration for the \'Reviews\' table runs in the correct order.',
  ),
  WordModel(
    id: 'word-nosql',
    word: 'NoSQL',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'Why use NoSQL for the user feed?',
    conversationA: 'The feed data is highly dynamic and doesn\'t need strict relational links. NoSQL allows us to scale horizontally much easier as our user base grows.',
  ),
  WordModel(
    id: 'word-document-store',
    word: 'Document Store',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'How should we store the blog posts?',
    conversationA: 'A document store is perfect. We can store the post, tags, and comments all in one JSON document for fast retrieval.',
  ),
  WordModel(
    id: 'word-mongodb',
    word: 'MongoDB',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'Is MongoDB a good fit for our e-commerce site?',
    conversationA: 'For the product catalog, yes. For the checkout and accounting, we might want a relational DB for the strict ACID guarantees.',
  ),
  WordModel(
    id: 'word-key-value',
    word: 'Key-Value',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'How are we tracking the active sessions?',
    conversationA: 'In a key-value store. The key is the session token, and the value is the user\'s data. It\'s lightning-fast.',
  ),
  WordModel(
    id: 'word-redis',
    word: 'Redis',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'Why use Redis for the leaderboard?',
    conversationA: 'Redis has built-in \'Sorted Sets\' which make updating and retrieving rankings incredibly fast compared to a traditional DB.',
  ),
  WordModel(
    id: 'word-graph-database',
    word: 'Graph Database',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'How do we find \'Friends of Friends\' efficiently?',
    conversationA: 'We should move this to a graph database. A relational DB would require slow, recursive joins that will kill performance at scale.',
  ),
  WordModel(
    id: 'word-in-memory',
    word: 'In-memory',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'Can we store the entire product catalog in-memory?',
    conversationA: 'If it\'s under 10GB, yes. It will make the storefront feel instant for our customers.',
  ),
  WordModel(
    id: 'word-eventually-consistent',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'Why is the \'Like\' count flickering?',
    conversationA: 'The database is eventually consistent. You\'re hitting different nodes that haven\'t all synced the new update yet.',
  ),
  WordModel(
    id: 'word-unstructured-data',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'NoSQL & Flexible Data',
    conversationQ: 'How are we handling the raw sensor logs?',
    conversationA: 'We\'re dumping them as unstructured data into S3. We\'ll run a processing job later to extract the useful bits into our database.',
  ),
  WordModel(
    id: 'word-replication',
    word: 'Replication',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'Is the database backup up to date?',
    conversationA: 'Yes, we have real-time replication set up. If the main server fails, the standby replica is ready to take over in seconds.',
  ),
  WordModel(
    id: 'word-sharding',
    word: 'Sharding',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'How do we handle a billion users?',
    conversationA: 'We\'ll need to shard the database. We can shard by region so European users\' data stays on servers in Europe.',
  ),
  WordModel(
    id: 'word-index',
    word: 'Index',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'Why is the dashboard loading so slowly?',
    conversationA: 'We forgot to add an index to the \'created_at\' column. The database is reading every single record just to find the latest ones.',
  ),
  WordModel(
    id: 'word-transaction',
    word: 'Transaction',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'What happens if the power goes out while I\'m transferring money?',
    conversationA: 'Our database uses transactions. If the process is interrupted, it will \'Roll Back\' so the money never leaves your account.',
  ),
  WordModel(
    id: 'word-backup',
    word: 'Backup',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'I accidentally deleted the production table!',
    conversationA: 'Don\'t panic. We have a backup from 2 AM. We can restore it to a temporary server and recover the lost data.',
  ),
  WordModel(
    id: 'word-read-replica',
    word: 'Read Replica',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'The main DB is at 90% CPU load.',
    conversationA: 'Let\'s move the \'Search\' traffic to a read replica. That will free up the main server for actual user signups and purchases.',
  ),
  WordModel(
    id: 'word-partition',
    word: 'Partition',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'How do we handle the old logs?',
    conversationA: 'We\'ll partition the table by month. This makes it easy to drop the oldest partition every year to save space.',
  ),
  WordModel(
    id: 'word-write-ahead-log-wal-',
    word: 'Write-Ahead Log (WAL)',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'Why is the database so fast after moving to WAL mode?',
    conversationA: 'WAL mode allows multiple processes to read and write at the same time more efficiently than traditional locking.',
  ),
  WordModel(
    id: 'word-data-integrity',
    word: 'Data Integrity',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'Why did the import fail?',
    conversationA: 'Data integrity check failed. Some of the imported users didn\'t have an email address, and our database requires one.',
  ),
  WordModel(
    id: 'word-optimistic-locking',
    ...
    category: 'Phase 5: The Memory',
    conceptId: 'Keeping Data in Sync',
    conversationQ: 'Why did my save fail with a \'Conflict Error\'?',
    conversationA: 'Optimistic locking caught a change. Someone else updated the profile while you had the form open. You need to refresh and try again.',
  ),
  WordModel(
    id: 'word-the-cloud',
    word: 'The Cloud',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Should we move our local servers to the cloud?',
    conversationA: 'Yes, it will reduce our maintenance overhead and let us scale our app automatically based on traffic.',
  ),
  WordModel(
    id: 'word-aws',
    word: 'AWS',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Which cloud provider are we using?',
    conversationA: 'We\'re on AWS. We\'re using S3 for storage, EC2 for servers, and Lambda for our background jobs.',
  ),
  WordModel(
    id: 'word-gcp',
    word: 'GCP',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Why did we choose GCP over AWS?',
    conversationA: 'Their BigQuery and Kubernetes services (GKE) are much more intuitive for our data science team.',
  ),
  WordModel(
    id: 'word-azure',
    word: 'Azure',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Is Azure safe for our sensitive data?',
    conversationA: 'Yes, it\'s highly compliant and integrates perfectly with our existing Active Directory security policies.',
  ),
  WordModel(
    id: 'word-saas',
    word: 'SaaS',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Should we build our own CRM?',
    conversationA: 'No, let\'s use a SaaS like HubSpot. It\'s much cheaper than paying developers to build and maintain a custom tool.',
  ),
  WordModel(
    id: 'word-paas',
    word: 'PaaS',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'How are we deploying the frontend?',
    conversationA: 'We\'re using Vercel. It\'s a PaaS that automatically builds and scales our site every time we push code to GitHub.',
  ),
  WordModel(
    id: 'word-iaas',
    word: 'IaaS',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Why not use a managed service for the DB?',
    conversationA: 'We need a very specific, old version of MySQL for this legacy app. IaaS allows us to install exactly what we need on a raw VM.',
  ),
  WordModel(
    id: 'word-serverless',
    word: 'Serverless',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'How do we handle the image processing?',
    conversationA: 'We\'ll use a serverless function. It will only run when a user uploads a photo, so we don\'t pay for it the rest of the time.',
  ),
  WordModel(
    id: 'word-region',
    word: 'Region',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Why is the app slow in Asia?',
    conversationA: 'All our servers are in the US-East region. We should deploy a cluster in the Tokyo region to serve our Asian users better.',
  ),
  WordModel(
    id: 'word-availability-zone',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'What happens if a data center burns down?',
    conversationA: 'We\'re deployed across three Availability Zones. The traffic would automatically failover to the other two healthy zones.',
  ),
  WordModel(
    id: 'word-on-premise',
    word: 'On-premise',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Can we move the hospital records to the cloud?',
    conversationA: 'Not easily. Legal requirements mandate that certain records must stay on-premise in our private, physical servers.',
  ),
  WordModel(
    id: 'word-multi-cloud',
    word: 'Multi-cloud',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Cloud Basics',
    conversationQ: 'Are we worried about AWS pricing hikes?',
    conversationA: 'A little, but our architecture is multi-cloud. We could migrate our core services to GCP in a few days if we had to.',
  ),
  WordModel(
    id: 'word-ci',
    word: 'CI',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Why is the CI pipeline failing?',
    conversationA: 'It looks like your latest change broke the login test. You\'ll need to fix that before your code can be merged.',
  ),
  WordModel(
    id: 'word-cd',
    word: 'CD',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'When will the new feature be live?',
    conversationA: 'As soon as the senior dev approves the PR, the CD pipeline will take over and it should be live in 5 minutes.',
  ),
  WordModel(
    id: 'word-pipeline',
    word: 'Pipeline',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Where did the deployment fail?',
    conversationA: 'It failed in the \'Build\' stage of the pipeline. It looks like we\'re missing a dependency in the production environment.',
  ),
  WordModel(
    id: 'word-build',
    word: 'Build',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Is the build finished?',
    conversationA: 'Yes, it\'s minified and ready to go. The total bundle size is only 150KB.',
  ),
  WordModel(
    id: 'word-artifact',
    word: 'Artifact',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Where can I find the latest version?',
    conversationA: 'The build artifact is in our S3 bucket. Just download the v1.2.0 zip file.',
  ),
  WordModel(
    id: 'word-staging',
    word: 'Staging',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Is the update safe to push?',
    conversationA: 'It looks good on Staging. I\'ve tested it with a copy of the production database and all the links are working.',
  ),
  WordModel(
    id: 'word-production',
    word: 'Production',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Is the site down in production?',
    conversationA: 'Checking the status page... yes, we\'re seeing a spike in 500 errors. I\'m rolling back the last deploy now.',
  ),
  WordModel(
    id: 'word-git',
    word: 'Git',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Who broke the navigation bar?',
    conversationA: 'Let me run \'git blame\'... looks like it was changed in the \'logo-update\' commit yesterday.',
  ),
  WordModel(
    id: 'word-branch',
    word: 'Branch',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Is the dark mode ready?',
    conversationA: 'I\'m still working on it in the \'feat/dark-mode\' branch. I\'ll merge it to main tomorrow.',
  ),
  WordModel(
    id: 'word-pull-request',
    word: 'Pull Request',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'Can you review my PR?',
    conversationA: 'Sure, I\'ll take a look at your checkout changes after lunch. Make sure the unit tests passed first.',
  ),
  WordModel(
    id: 'word-commit',
    word: 'Commit',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Shipping Code (CI/CD)',
    conversationQ: 'When did we add the new API?',
    conversationA: 'Check the commit history. It was added in the commit on Oct 14th labeled \'Core: initialize API routes\'.',
  ),
  WordModel(
    id: 'word-container',
    word: 'Container',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Why is the app failing in production but working for me?',
    conversationA: 'We\'re not using containers yet. Your laptop has a different version of Node than the server. We should containerize this with Docker.',
  ),
  WordModel(
    id: 'word-image',
    word: 'Image',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Which image are we deploying?',
    conversationA: 'We\'re using the \'api-server:v2.1.0\' image from our private registry.',
  ),
  WordModel(
    id: 'word-docker',
    word: 'Docker',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Do I need to install Python to run the backend?',
    conversationA: 'No, just run \'docker-compose up\'. Docker will download the image and handle everything inside the container for you.',
  ),
  WordModel(
    id: 'word-vm',
    word: 'VM',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Is a container just a small VM?',
    conversationA: 'Not exactly. A VM emulates hardware and runs a whole OS. A container shares the host\'s OS kernel, making it 10x lighter and faster.',
  ),
  WordModel(
    id: 'word-hypervisor',
    word: 'Hypervisor',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Which hypervisor is the cloud using?',
    conversationA: 'Most of our AWS instances run on the Nitro hypervisor, which provides near-native performance for our VMs.',
  ),
  WordModel(
    id: 'word-isolation',
    word: 'Isolation',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'How do we stop the test database from deleting production data?',
    conversationA: 'Network isolation. The test environment is in a separate VPC and has no physical way to reach the production database.',
  ),
  WordModel(
    id: 'word-dockerfile',
    word: 'Dockerfile',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'How do I update the Node version?',
    conversationA: 'Just change the first line of the Dockerfile from \'FROM node:14\' to \'FROM node:18\' and rebuild the image.',
  ),
  WordModel(
    id: 'word-registry',
    word: 'Registry',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Where do I find the production image?',
    conversationA: 'It\'s in our private AWS Registry. You\'ll need to log in with your IAM credentials to pull it.',
  ),
  WordModel(
    id: 'word-daemon',
    word: 'Daemon',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Docker isn\'t responding.',
    conversationA: 'It looks like the Docker daemon crashed. Try restarting the service on your machine.',
  ),
  WordModel(
    id: 'word-volume',
    word: 'Volume',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Containers (Docker)',
    conversationQ: 'Why did we lose the database after the update?',
    conversationA: 'We forgot to mount a volume. When the container was deleted for the new version, all the data inside it was deleted too.',
  ),
  WordModel(
    id: 'word-kubernetes',
    word: 'Kubernetes',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'Why use K8s?',
    conversationA: 'It provides self-healing, auto-scaling, and easy rollbacks for our 50 different microservices.',
  ),
  WordModel(
    id: 'word-cluster',
    word: 'Cluster',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'How big is our production cluster?',
    conversationA: 'We\'re currently running 10 nodes, which gives us enough CPU and RAM to handle our peak traffic.',
  ),
  WordModel(
    id: 'word-node-kubernetes-',
    word: 'Node(Kubernetes)',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'A node just went offline!',
    conversationA: 'No problem. Kubernetes detected the failure and is already moving all the pods from that node to the healthy ones.',
  ),
  WordModel(
    id: 'word-pod',
    word: 'Pod',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'How many pods are running?',
    conversationA: 'We have 5 pods for the web server to handle the load, and 2 pods for the background worker.',
  ),
  WordModel(
    id: 'word-control-plane',
    word: 'Control Plane',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'Is the cluster healthy?',
    conversationA: 'The Control Plane is responding normally, but it\'s reporting that two worker nodes are struggling with high memory usage.',
  ),
  WordModel(
    id: 'word-ingress',
    word: 'Ingress',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'How do we route traffic to the new blog?',
    conversationA: 'We\'ll add a new rule to our Ingress controller to send all traffic for \'/blog\' to the \'blog-service\' pods.',
  ),
  WordModel(
    id: 'word-auto-scaling',
    word: 'Auto-scaling',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'Did the site crash during the Super Bowl ad?',
    conversationA: 'No, auto-scaling kicked in and added 20 extra pods in under a minute to handle the massive traffic spike.',
  ),
  WordModel(
    id: 'word-helm',
    word: 'Helm',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'How do we install Prometheus?',
    conversationA: 'Just use the Helm chart. It\'s the fastest way to set up the whole monitoring stack with best-practice configurations.',
  ),
  WordModel(
    id: 'word-statefulset',
    word: 'StatefulSet',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'Can we run the database in Kubernetes?',
    conversationA: 'Yes, but we must use a StatefulSet to ensure that each database pod keeps its own dedicated storage volume.',
  ),
  WordModel(
    id: 'word-configmap',
    word: 'ConfigMap',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'How do I change the log level to \'debug\'?',
    conversationA: 'Update the value in the K8s ConfigMap and restart the pods. They\'ll pick up the new setting automatically.',
  ),
  WordModel(
    id: 'word-secrets',
    word: 'Secrets',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Orchestration (K8s)',
    conversationQ: 'Where is the Stripe API key stored?',
    conversationA: 'It\'s in a K8s Secret. The app reads it as an environment variable at runtime, but it\'s encrypted at rest in the cluster.',
  ),
  WordModel(
    id: 'word-uptime',
    word: 'Uptime',
    ...
    conversationQ: 'What was our uptime last month?',
    conversationA: 'We hit 99.95%. Most of the downtime was due to that one database migration that took longer than expected.',
  ),
  WordModel(
    id: 'word-downtime',
    word: 'Downtime',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'Why did we have 20 minutes of downtime?',
    conversationA: 'A bad configuration push caused the load balancer to stop routing traffic. We\'ve added a validation step to prevent it next time.',
  ),
  WordModel(
    id: 'word-sla-slo',
    word: 'SLA/SLO',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'Are we meeting our SLA?',
    conversationA: 'Yes, but our SLO for response time is trending down. We need to optimize our API before we start failing our customer promises.',
  ),
  WordModel(
    id: 'word-logs',
    word: 'Logs',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'Why did the payment fail?',
    conversationA: 'Checking the logs... it looks like the Stripe API returned a \'Card Declined\' error for user #502.',
  ),
  WordModel(
    id: 'word-metrics',
    word: 'Metrics',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'Is the server struggling?',
    conversationA: 'The metrics show CPU usage is spiking every 10 minutes. It\'s likely a cron job that\'s doing too much work.',
  ),
  WordModel(
    id: 'word-tracing',
    word: 'Tracing',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'The checkout is slow for some users.',
    conversationA: 'Looking at the trace, the \'Inventory\' service is taking 3 seconds to respond. We need to cache those results.',
  ),
  WordModel(
    id: 'word-monitoring',
    word: 'Monitoring',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'How did we miss that outage?',
    conversationA: 'Our monitoring wasn\'t checking the specific \'Search\' endpoint. We\'ve added a new health check for it now.',
  ),
  WordModel(
    id: 'word-alerting',
    word: 'Alerting',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'Why is my phone buzzing at 3 AM?',
    conversationA: 'It\'s a critical alert. The database just ran out of disk space, and we\'re currently 100% offline.',
  ),
  WordModel(
    id: 'word-dashboard',
    word: 'Dashboard',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'How\'s the launch going?',
    conversationA: 'Take a look at the dashboard. Traffic is up 300% but our latency is staying steady under 200ms. Everything is green!',
  ),
  WordModel(
    id: 'word-incident',
    word: 'Incident',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'Is the incident over?',
    conversationA: 'Yes, we\'ve applied the hotfix and traffic has returned to normal. Now we need to start the post-mortem process.',
  ),
  WordModel(
    id: 'word-rca',
    word: 'RCA',
    ...
    category: 'Phase 6: The Factory',
    conceptId: 'Observability',
    conversationQ: 'What was the RCA for the database crash?',
    conversationA: 'The root cause was a missing index on a large table, which caused queries to pile up until the server ran out of memory.',
  ),
  WordModel(
    id: 'word-big-data',
    word: 'Big Data',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Are we a Big Data company?',
    conversationA: 'Not yet. We\'re only processing a few gigabytes a day. We\'ll stick with Postgres until we hit the Terabyte range.',
  ),
  WordModel(
    id: 'word-etl',
    word: 'ETL',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Why are the sales numbers wrong?',
    conversationA: 'The ETL job failed last night. It extracted the data but crashed during the transformation step because of a new currency code.',
  ),
  WordModel(
    id: 'word-data-warehouse',
    word: 'Data Warehouse',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Where should I run the quarterly growth report?',
    conversationA: 'Run it on Snowflake (our data warehouse). It\'s built for those massive queries and won\'t impact our production site.',
  ),
  WordModel(
    id: 'word-data-lake',
    word: 'Data Lake',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'We need to analyze the logs from 2 years ago.',
    conversationA: 'They are in the Data Lake on S3. We can use Amazon Athena to query the raw files directly without importing them anywhere.',
  ),
  WordModel(
    id: 'word-analytics',
    word: 'Analytics',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Is the new checkout better?',
    conversationA: 'The analytics show that users are finishing the process 20% faster than they were with the old design.',
  ),
  WordModel(
    id: 'word-pipelines',
    word: 'Pipelines',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Why is the recommendation engine outdated?',
    conversationA: 'The data pipeline is stuck on the \'Normalization\' step. A single weird character in the input is causing the whole chain to stall.',
  ),
  WordModel(
    id: 'word-data-cleaning',
    word: 'Data Cleaning',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Is the dataset ready for the AI model?',
    conversationA: 'Not yet. I\'m still in the cleaning phase, removing all the bot traffic so the model doesn\'t learn from fake data.',
  ),
  WordModel(
    id: 'word-visualization',
    word: 'Visualization',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'How do we explain the server costs to the CEO?',
    conversationA: 'Let\'s create a visualization. A bar chart comparing traffic to cost will clearly show that the price is actually dropping per user.',
  ),
  WordModel(
    id: 'word-business-intelligence',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Data Science 101',
    conversationQ: 'Do we have a BI tool set up?',
    conversationA: 'Yes, we\'re using Looker. It connects directly to our data warehouse and gives the marketing team their own dashboard.',
  ),
  WordModel(
    id: 'word-model',
    word: 'Model',
    ...
    conversationQ: 'Can the model detect fraud?',
    conversationA: 'Yes, but we need to retrain it. The fraudsters changed their tactics, and the old model is starting to miss the new patterns.',
  ),
  WordModel(
    id: 'word-algorithm',
    word: 'Algorithm',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'Which algorithm should we use for house prices?',
    conversationA: 'Let\'s start with a simple Linear Regression. It\'s easy to interpret and usually very accurate for pricing data.',
  ),
  WordModel(
    id: 'word-training-data',
    word: 'Training Data',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'Why is the AI failing on mobile photos?',
    conversationA: 'All our training data was high-res professional photos. We need to add more messy, low-light mobile photos to the training set.',
  ),
  WordModel(
    id: 'word-inference',
    word: 'Inference',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'How long does it take for the AI to answer?',
    conversationA: 'The inference time is about 200ms. We\'re running the model on a GPU server to keep it snappy for the user.',
  ),
  WordModel(
    id: 'word-supervised',
    word: 'Supervised',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'Is this model supervised?',
    conversationA: 'Yes, we used supervised learning with our historical sales data to predict next month\'s revenue.',
  ),
  WordModel(
    id: 'word-unsupervised',
    word: 'Unsupervised',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'How did the AI know these users were similar?',
    conversationA: 'We used an unsupervised clustering algorithm. It found that these users all shop at 3 AM and buy similar items.',
  ),
  WordModel(
    id: 'word-neural-network',
    word: 'Neural Network',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'Why is the model so hard to explain?',
    conversationA: 'It\'s a deep neural network with 50 layers. It\'s a \'Black Box\'—we know it works, but we can\'t see the exact math it\'s using for every decision.',
  ),
  WordModel(
    id: 'word-bias',
    word: 'Bias',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'The AI is only suggesting jobs to men.',
    conversationA: 'That\'s a massive bias in our training data. We need to balance the dataset so the AI learns that anyone can do any job.',
  ),
  WordModel(
    id: 'word-overfitting',
    word: 'Overfitting',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'The model has 99% accuracy on our data but fails in the real world.',
    conversationA: 'It\'s overfit. It\'s essentially memorized our specific dataset and can\'t handle anything new. We need to simplify the model.',
  ),
  WordModel(
    id: 'word-weights',
    word: 'Weights',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'How does the AI know the tail is important?',
    conversationA: 'The weight for the \'tail\' feature was turned up high during training because it consistently helped the AI identify dogs.',
  ),
  WordModel(
    id: 'word-parameters',
    word: 'Parameters',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Machine Learning',
    conversationQ: 'Is the new model better?',
    conversationA: 'It has 5x more parameters than the old one, which allows it to understand much more nuanced human language.',
  ),
  WordModel(
    id: 'word-llm',
    word: 'LLM',
    ...
    conversationQ: 'How does the chatbot sound so human?',
    conversationA: 'It\'s an LLM. It\'s been trained on billions of human conversations, so it knows exactly how to phrase an answer to sound helpful.',
  ),
  WordModel(
    id: 'word-gpt',
    word: 'GPT',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'Is GPT actually smart?',
    conversationA: 'It\'s incredibly good at pattern matching. It doesn\'t have a \'Consciousness\', but it can reason through problems by following patterns in its data.',
  ),
  WordModel(
    id: 'word-token',
    word: 'Token',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'Why did the AI stop mid-sentence?',
    conversationA: 'We hit the \'Max Tokens\' limit for the response. We need to increase the limit or ask the AI to be more concise.',
  ),
  WordModel(
    id: 'word-hallucination',
    word: 'Hallucination',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'The AI said this book exists, but I can\'t find it.',
    conversationA: 'That\'s a hallucination. The AI knows what a book title *should* look like, so it invented one that sounded real.',
  ),
  WordModel(
    id: 'word-prompt',
    word: 'Prompt',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'How do I get the AI to write better code?',
    conversationA: 'Improve your prompt. Give it an example of the style you want and tell it exactly which libraries it should use.',
  ),
  WordModel(
    id: 'word-fine-tuning',
    word: 'Fine-tuning',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'Why isn\'t the AI using our specific terminology?',
    conversationA: 'We should fine-tune it. If we give it 500 examples of our technical docs, it will learn to use our phrasing naturally.',
  ),
  WordModel(
    id: 'word-rag',
    word: 'RAG',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'How does the AI know our internal HR policy?',
    conversationA: 'We\'re using RAG. Every time you ask a question, our system searches our internal docs and feeds the relevant text to the AI.',
  ),
  WordModel(
    id: 'word-multimodal',
    word: 'Multimodal',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'Can I show the AI a sketch of my website idea?',
    conversationA: 'Yes, our model is multimodal. It can \'Look\' at your sketch and write the actual HTML/CSS code to build it.',
  ),
  WordModel(
    id: 'word-vector-database',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'How did the AI find the answer without the exact keywords?',
    conversationA: 'We\'re using a vector database. It understands that \'How do I quit?\' and \'Resignation Process\' mean the same thing.',
  ),
  WordModel(
    id: 'word-context-window',
    word: 'Context Window',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'Why did the AI forget the beginning of our chat?',
    conversationA: 'We exceeded the context window. It\'s like it ran out of room in its short-term memory and started forgetting the oldest parts.',
  ),
  WordModel(
    id: 'word-embeddings',
    word: 'Embeddings',
    ...
    category: 'Phase 7: The Brain',
    conceptId: 'Generative AI',
    conversationQ: 'How do we compare two user reviews?',
    conversationA: 'We\'ll convert them both into embeddings. Then we can use math to see if they are expressing the same sentiment.',
  ),
  WordModel(
    id: 'word-authn',
    word: 'AuthN',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Is the user authenticated?',
    conversationA: 'Yes, they provided the correct password and completed the 2FA check. Their AuthN is successful.',
  ),
  WordModel(
    id: 'word-authz',
    word: 'AuthZ',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Why can\'t I edit this post?',
    conversationA: 'You\'re authenticated as a \'Viewer\', but you don\'t have the \'Editor\' AuthZ permissions for this specific document.',
  ),
  WordModel(
    id: 'word-oauth',
    word: 'OAuth',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Can we import the user\'s contacts?',
    conversationA: 'We\'ll need to use OAuth. We\'ll ask the user for permission to access their contact list through Google\'s API.',
  ),
  WordModel(
    id: 'word-sso',
    word: 'SSO',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Why do I have to log in to every tool separately?',
    conversationA: 'We haven\'t set up SSO yet. Once we do, you\'ll only have to log in once in the morning to access everything.',
  ),
  WordModel(
    id: 'word-mfa',
    word: 'MFA',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Is my account safe?',
    conversationA: 'It\'s much safer now that we\'ve enabled MFA. Even if someone guesses your password, they can\'t access your data.',
  ),
  WordModel(
    id: 'word-jwt',
    word: 'JWT',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'How does the server know who I am?',
    conversationA: 'Your browser is sending a JWT in the header of every request. The server verifies the signature to make sure it hasn\'t been tampered with.',
  ),
  WordModel(
    id: 'word-rbac',
    word: 'RBAC',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Can Sarah access the billing settings?',
    conversationA: 'Yes, I just added her to the \'Admin\' role in our RBAC system, so she has full access now.',
  ),
  WordModel(
    id: 'word-identity-provider',
    word: 'Identity Provider',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Who handles our user logins?',
    conversationA: 'We\'re using Auth0 as our Identity Provider. They handle all the password resets and security checks for us.',
  ),
  WordModel(
    id: 'word-principal',
    word: 'Principal',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Who made this change?',
    conversationA: 'The audit log shows the principal was the \'backup-service\' account, not an actual human user.',
  ),
  WordModel(
    id: 'word-scopes',
    word: 'Scopes',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Identity & Access',
    conversationQ: 'Why does the app need my profile info?',
    conversationA: 'It\'s asking for the \'profile\' scope so it can show your name and avatar in the dashboard.',
  ),
  WordModel(
    id: 'word-encryption',
    word: 'Encryption',
    ...
    conversationQ: 'Is the data safe in the database?',
    conversationA: 'Yes, we\'re using AES-256 encryption at rest. Even if someone physicaly steals the disks, they can\'t read a single byte.',
  ),
  WordModel(
    id: 'word-decryption',
    word: 'Decryption',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Why is the message still scrambled?',
    conversationA: 'The decryption failed. It looks like you\'re using the wrong private key for this specific encrypted file.',
  ),
  WordModel(
    id: 'word-hashing',
    word: 'Hashing',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Can the admin see my password?',
    conversationA: 'No. We only store a hash of your password. We don\'t even know what your password is, and we can\'t \'decrypt\' it.',
  ),
  WordModel(
    id: 'word-salt',
    word: 'Salt',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Why use salt if the hash is already secure?',
    conversationA: 'If two users have the password \'password123\', their hashes would be identical. Salt makes them unique, which stops hackers from cracking them both at once.',
  ),
  WordModel(
    id: 'word-public-key',
    word: 'Public Key',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'How do I send you a secure file?',
    conversationA: 'Use my public key to encrypt it. Once you do that, only I can open it with my secret private key.',
  ),
  WordModel(
    id: 'word-private-key',
    word: 'Private Key',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Why is the server compromised?',
    conversationA: 'Someone accidentally pushed the private key for the server to a public GitHub repo. We need to revoke and replace it immediately.',
  ),
  WordModel(
    id: 'word-ssl-tls',
    word: 'SSL/TLS',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Is the connection secure?',
    conversationA: 'Yes, we have a valid TLS certificate, so the data between your browser and our server is completely encrypted.',
  ),
  WordModel(
    id: 'word-certificate',
    word: 'Certificate',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Why is the browser saying \'Your connection is not private\'?',
    conversationA: 'Our SSL certificate expired yesterday. I\'m renewing it now to get the padlock icon back.',
  ),
  WordModel(
    id: 'word-cipher',
    word: 'Cipher',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Which cipher are we using?',
    conversationA: 'We\'re using the AES-256 cipher, which is currently the global standard for high-security data protection.',
  ),
  WordModel(
    id: 'word-e2ee',
    word: 'E2EE',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'Encryption',
    conversationQ: 'Can the government read my messages?',
    conversationA: 'Not if we use E2EE. The keys are only on your phone and the receiver\'s phone; they never touch our servers.',
  ),
  WordModel(
    id: 'word-ddos',
    word: 'DDoS',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'The site is down and the CPU is at 100%!',
    conversationA: 'We\'re under a DDoS attack. Millions of fake requests are hitting our server. I\'m turning on Cloudflare\'s \'Under Attack\' mode now.',
  ),
  WordModel(
    id: 'word-phishing',
    word: 'Phishing',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Why did the admin account get compromised?',
    conversationA: 'They fell for a phishing email that looked exactly like a Google login page. Luckily, our MFA blocked the hacker from getting in.',
  ),
  WordModel(
    id: 'word-sql-injection',
    word: 'SQL Injection',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Is our search bar safe?',
    conversationA: 'Yes, we\'re using an ORM that automatically sanitizes all user input, which prevents SQL injection attacks.',
  ),
  WordModel(
    id: 'word-zero-day',
    word: 'Zero-Day',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Why is everyone panicking about Chrome today?',
    conversationA: 'A major zero-day exploit was found. Hackers are using it to steal data, and Google just released an emergency update to fix it.',
  ),
  WordModel(
    id: 'word-malware',
    word: 'Malware',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Why is the computer so slow and showing random ads?',
    conversationA: 'It\'s likely infected with malware. We need to disconnect it from the network and run a full security scan.',
  ),
  WordModel(
    id: 'word-ransomware',
    word: 'Ransomware',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'What happens if we get hit by ransomware?',
    conversationA: 'We\'ll lose our current work, but we can restore the whole system from our immutable cloud backups within 4 hours.',
  ),
  WordModel(
    id: 'word-vulnerability',
    word: 'Vulnerability',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Is our app secure?',
    conversationA: 'We have 3 high-priority vulnerabilities in our third-party libraries. I\'m updating those packages now to close the holes.',
  ),
  WordModel(
    id: 'word-pentest',
    word: 'Pentest',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Why are we hiring these hackers?',
    conversationA: 'It\'s for a pentest. They are going to spend a week trying to steal our user data so we can fix our security before we launch.',
  ),
  WordModel(
    id: 'word-firewall',
    word: 'Firewall',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'Why can\'t I connect to the database?',
    conversationA: 'The firewall is doing its job! It\'s blocking your home IP. I\'ll need to whitelist your address so you can access it.',
  ),
  WordModel(
    id: 'word-encryption-at-rest',
    ...
    category: 'Phase 8: The Shield',
    conceptId: 'The Attack Surface',
    conversationQ: 'What if Amazon steals our data?',
    conversationA: 'They can\'t. We\'re using \'Encryption at Rest\' with our own keys. All they see on their physical disks is scrambled noise.',
  ),
  WordModel(
    id: 'word-agile',
    word: 'Agile',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'How is the team working?',
    conversationA: 'We\'re using Agile. We release a small update every two weeks and get feedback from our users immediately.',
  ),
  WordModel(
    id: 'word-waterfall',
    word: 'Waterfall',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Why is the project taking so long to start?',
    conversationA: 'We\'re using Waterfall. We\'re still in the \'Requirements\' phase and won\'t start writing code for another two months.',
  ),
  WordModel(
    id: 'word-scrum',
    word: 'Scrum',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'What\'s our plan for the next two weeks?',
    conversationA: 'It\'s time for Scrum Planning. We\'ll look at the backlog and decide which features we can finish in the next sprint.',
  ),
  WordModel(
    id: 'word-kanban',
    word: 'Kanban',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Why are no new tasks being started?',
    conversationA: 'Our Kanban board shows our \'In Progress\' column is full. We need to finish the current tasks before we pull anything new from the backlog.',
  ),
  WordModel(
    id: 'word-sprint',
    word: 'Sprint',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Will the search feature be in the next update?',
    conversationA: 'Yes, it\'s our main goal for the upcoming sprint. It should be ready in two weeks.',
  ),
  WordModel(
    id: 'word-standup',
    word: 'Standup',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Is the database fix done?',
    conversationA: 'As I said in the standup this morning, I finished the fix yesterday and I\'m just waiting for the tests to pass today.',
  ),
  WordModel(
    id: 'word-backlog',
    word: 'Backlog',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'When are we fixing the dark mode bug?',
    conversationA: 'It\'s currently at the top of the backlog. We\'ll pull it into the very next sprint.',
  ),
  WordModel(
    id: 'word-velocity',
    word: 'Velocity',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Can we finish both features this month?',
    conversationA: 'Our average velocity is 30 points per sprint. Those two features together are 50 points, so we can probably only finish one.',
  ),
  WordModel(
    id: 'word-burndown-chart',
    word: 'Burndown Chart',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Are we going to finish everything by Friday?',
    conversationA: 'Look at the burndown chart. We\'re slightly above the line, so we need to focus and maybe move one small task to the next sprint.',
  ),
  WordModel(
    id: 'word-retro',
    word: 'Retro',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'Why did the deployment fail again?',
    conversationA: 'Let\'s discuss that in the retro this afternoon. We need to figure out why our testing process didn\'t catch the error.',
  ),
  WordModel(
    id: 'word-story-points',
    word: 'Story Points',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Methodology',
    conversationQ: 'How long will the login fix take?',
    conversationA: 'It\'s only a 2-point task. It\'s a simple fix we\'ve done before, so it should be very quick.',
  ),
  WordModel(
    id: 'word-mvp',
    word: 'MVP',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'Should we add the dark mode and the social sharing now?',
    conversationA: 'No, let\'s stick to the MVP. We just need the \'Core\' search feature to work so we can see if users find it valuable.',
  ),
  WordModel(
    id: 'word-roadmap',
    word: 'Roadmap',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'When are we getting the mobile app?',
    conversationA: 'According to the product roadmap, development for mobile starts in Q3, after we finish the web API.',
  ),
  WordModel(
    id: 'word-feature-creep',
    word: 'Feature Creep',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'Can we also add a weather widget to the dashboard?',
    conversationA: 'That sounds like feature creep. It\'s not part of our core goal, and it will delay the launch by another week.',
  ),
  WordModel(
    id: 'word-spec',
    word: 'Spec',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'How should the login error look?',
    conversationA: 'Check the spec. It says the error should be a red banner at the top of the page with the text \'Invalid Credentials\'.',
  ),
  WordModel(
    id: 'word-stakeholder',
    word: 'Stakeholder',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'Did the stakeholders approve the new design?',
    conversationA: 'The CEO and the Marketing team love it, but the Engineering team is worried about the complexity. We need to find a compromise.',
  ),
  WordModel(
    id: 'word-qa',
    word: 'QA',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'Is the new version ready for launch?',
    conversationA: 'Not yet. QA found a major bug in the checkout process on Safari. We need to fix that first.',
  ),
  WordModel(
    id: 'word-beta',
    word: 'Beta',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'How\'s the new app doing?',
    conversationA: 'It\'s in private Beta. We have 100 users testing it, and their feedback is helping us fix a lot of small UI issues.',
  ),
  WordModel(
    id: 'word-ga',
    word: 'GA',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Product Lifecycle',
    conversationQ: 'Is the new API ready?',
    conversationA: 'It\'s been in Beta for a month, and we\'re moving it to GA next Tuesday. All our customers can start using it then.',
  ),
  WordModel(
    id: 'word-tech-debt',
    word: 'Tech Debt',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Why is it taking so long to add a simple button?',
    conversationA: 'We have too much tech debt in the header component. I have to refactor the whole thing before I can add the new button.',
  ),
  WordModel(
    id: 'word-refactoring-code',
    word: 'Refactoring Code',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Why are you changing the login code if it\'s already working?',
    conversationA: 'I\'m refactoring it. It\'s currently a mess of nested if-statements, and I\'m making it cleaner so it\'s easier to add new features later.',
  ),
  WordModel(
    id: 'word-legacy-code',
    word: 'Legacy Code',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Can we update the database library?',
    conversationA: 'It\'s tricky. The core logic is built on legacy code that uses a very old version of that library. We\'ll need to be very careful.',
  ),
  WordModel(
    id: 'word-bug',
    word: 'Bug',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Why did the app crash?',
    conversationA: 'It was a bug in the new search filter. It was trying to read data from a file that didn\'t exist.',
  ),
  WordModel(
    id: 'word-feature',
    word: 'Feature',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'What\'s the best part of the new update?',
    conversationA: 'Definitely the \'One-click Login\' feature. Users are loving how much faster it makes the app.',
  ),
  WordModel(
    id: 'word-hotfix',
    word: 'Hotfix',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Is the site back up?',
    conversationA: 'Yes, we just pushed a hotfix to fix the login crash. We\'ll do a full proper fix in the next sprint.',
  ),
  WordModel(
    id: 'word-edge-case',
    word: 'Edge Case',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Why did the system crash for this one user?',
    conversationA: 'It was an edge case. They tried to upload a file that was exactly 0 bytes, and our code didn\'t know how to handle that.',
  ),
  WordModel(
    id: 'word-trade-off',
    word: 'Trade-off',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'Should we use a more secure encryption?',
    conversationA: 'It\'s a trade-off. It will make our data much safer, but it will also make the app 30% slower for our users.',
  ),
  WordModel(
    id: 'word-documentations',
    word: 'Documentations',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'How do I set up the development environment?',
    conversationA: 'Check the README file in the repository. The documentation has a step-by-step guide for new developers.',
  ),
  WordModel(
    id: 'word-bus-factor',
    word: 'Bus Factor',
    ...
    category: 'Phase 9: The Process',
    conceptId: 'Engineering Reality',
    conversationQ: 'What happens if Dave leaves the company?',
    conversationA: 'Our bus factor is currently 1 for the database. We need Dave to train someone else so we\'re not in trouble if he leaves.',
  ),
];
